...
public abstract class RecentsView<T extends BaseActivity> extends PagedView implements Insettable {
    ...
    private static final String TAG = "RecentLog";
...
//        Log.d("RecentLog", "onWindowVisibilityChanged: " + visibility);
    ...
    protected void onAttachedToWindow() {
        ...
        //   Log.d("RecentLog", "onAttachedToWindow ");
        updateTaskStackListenerState();
    ...
    protected void onDetachedFromWindow() {
        ...
        //   Log.d("RecentLog", "onDetachedFromWindow: ");
        updateTaskStackListenerState();
    ...
    private int currenTaskCount;

    private void applyLoadPlan(RecentsTaskLoadPlan loadPlan) {
        Log.d(TAG, "applyLoadPlan --------打开任务栏------ ");
        ...
        Log.d("RecentLog", "后台任务数: " + requiredTaskCount);
        UiFactory.setAllButtonVisibity(requiredTaskCount);
...
//                        "   requiredTaskCount:" + requiredTaskCount);
            ...
            if (requiredTaskCount > 0) {
                ...
                // Log.d("RecentLog", "applyLoadPlan   add Button success ");
            }
        }
    ...
    public int getTaskViewCount() {
        ...
        return childCount == 0 ? 0 : childCount;//不再包含按钮视图
    }
    ...
    public void resetTaskVisuals() {
        ...
        applyIconScale(false /* animate */);//屏蔽任务栏消失动画无效 2021 07 20
    ...
    public void showNextTask() {
        ...
        if (runningTaskView == null) {
            ...
            if (getTaskViewCount() > 0) {
                ((TaskView) getChildAt(0)).launchTask(true /* animate */);//----首个视图是按钮  2021 06 30
    ...
    private void removeTask(Task task, int index, PendingAnimation.OnEndListener onEndListener,
                            boolean shouldLog) {
        if (task != null) {
            Log.d("Deson21", "removeTask launcher");
            ...
            //Add By Deson 
            //kill the app whom removed
            if (removedTask != null && removedTask.key != null) {
                String pkgName = removedTask.key.getPackageName();
                Log.d("Deson", "remove task is: " + pkgName);
                if (!isWhiteListApk(pkgName)) {
                    //isn't in white list ,then kill them
                    try {
                        Intent intent = new Intent("com.android.launcher3.task.removed");
                        intent.putExtra("packageName", pkgName);
                        getContext().sendBroadcast(intent);
//                  	  ActivityManager am = (ActivityManager)getContext().getSystemService(
//                              Context.ACTIVITY_SERVICE);
//                          Log.i("Deson", "Stop running 840" + pkgName);
//                          am.forceStopPackage(pkgName);
                    } catch (Exception e) {
                        Log.i("Deson", "Stop running ex" + e.getMessage());
                    }
    ...
    private String[] whiteList = new String[]{"com.carsyso.main", "com.android.settings", "com.suding.launcher"};


    private boolean isWhiteListApk(String pkgName) {
    ...
    //改成对外提供
    public void runDismissAnimation(PendingAnimation pendingAnim) {
    ...
    public void setContentAlpha(float alpha) {
        ...
        // Log.d("RecentLog", "setContentAlpha: 透明度值:" + mContentAlpha);
