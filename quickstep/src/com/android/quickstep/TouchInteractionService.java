...
public class TouchInteractionService extends Service {
    ...
    private final IBinder mMyBinder = new IOverviewProxy.Stub() {
        ...
        public void onPreMotionEvent(@HitTarget int downHitTarget) throws RemoteException {
            Log.d(TAG, "onPreMotionEvent: " + downHitTarget);
        ...
        public void onQuickScrubProgress(float progress) {
            Log.d(TAG, "onQuickScrubProgress: ");
            mEventQueue.onQuickScrubProgress(progress);
        }

        @Override
        public void onQuickScrubEnd() {
            Log.d(TAG, "onQuickScrubEnd: ");
    ...
    public IBinder onBind(Intent intent) {
        Log.d(TAG, " onBind Touch service connected");
        return mMyBinder;
    }
    ...
    private static class OverviewTouchConsumer<T extends BaseDraggingActivity>
        ...
        public void updateTouchTracking(int interactionType) {
            Log.d(TAG, "updateTouchTracking type:" + interactionType);
            if (mInvalidated) {
                return;
            }
    ...
    private void initBackgroundChoreographer() {
        Log.d(TAG, "initBackgroundChoreographer");
