...
public class RecentsActivity extends BaseDraggingActivity {
    ...
    public ClearAllButton mOvCleanBtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //  android.util.Log.d("traceLog","onCreate");
        mRecentsRootView = findViewById(R.id.drag_layer);
        mFallbackRecentsView = findViewById(R.id.overview_panel);//RecentsViews 装载最近任务
        mOvCleanBtn = findViewById(R.id.ov_cleanAllButton);//添加一个按钮

        mRecentsRootView.setup();
        Log.d("RecentsActivity", "onCreate: 最近任务activity");
    ...
    private void cleanRecents() {
        mOvCleanBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Log.d("RecentsActivity", "onClick: 清理所有app");
                RecentsView recentsView = getOverviewPanel();
                recentsView.dismissAllTasks(mOvCleanBtn);
            }
        });
    }
    ...
    protected void onResume() {
        super.onResume();
        Log.d("RecentsActivity", "onResume: 后台任务界面显示了");
//        RecentsView overviewPanel = getOverviewPanel();
//        if (overviewPanel.getTaskViewCount() > 0) {
//            mOvCleanBtn.setVisibility(View.VISIBLE);
//        } else {
//            mOvCleanBtn.setVisibility(View.GONE);
//        }
    }
