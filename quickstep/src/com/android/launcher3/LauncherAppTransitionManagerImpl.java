...
public class LauncherAppTransitionManagerImpl extends LauncherAppTransitionManager
    ...
    private static final int APP_LAUNCH_DURATION = 20;//修改启动app时间更快一些
    ...
    public static final int RECENTS_LAUNCH_DURATION = 100;//336
    public static final int RECENTS_QUICKSCRUB_LAUNCH_DURATION = 300;
    private static final int LAUNCHER_RESUME_START_DELAY = 10;//100
    private static final int CLOSING_TRANSITION_DURATION_MS = 25;// 250
            ...
            RemoteAnimationRunnerCompat runner = new LauncherAnimationRunner(mHandler,
                ...
                public void onCreateAnimation(RemoteAnimationTargetCompat[] targetCompats,
                    ...
                    if (!composeRecentsLaunchAnimator(v, targetCompats, anim)) {
                        Log.d("Launcher", "onCreateAnimation  launcherClosing:" + launcherClosing);
                        ...
                        if (launcherClosing) {
                            Pair<AnimatorSet, Runnable> launcherContentAnimator =
                                    getLauncherContentAnimator(true /* isAppOpening true*/);
...
//                            });
    ...
    private Pair<AnimatorSet, Runnable> getLauncherContentAnimator(boolean isAppOpening) {
       ...
       // Log.d(TAG, "getLauncherContentAnimator  isAppOpening:" + isAppOpening);//最近任务栏消失动画无关
   ...
   /*        屏蔽打开app时候的向下动画过渡画面
    ObjectAnimator alpha =
            ...
            */
            ...
            // mLauncher.getWorkspace().getPageIndicator().pauseAnimations(); 不要这个  2021
    ...
    private void playIconAnimators(AnimatorSet appOpenAnimator, View v, Rect windowTargetBounds) {
        ...
        // ((ViewGroup) mDragLayer.getParent()).addView(mFloatingView); //屏蔽添加 点击桌面图标时候就不会有讨厌的小图过渡2021 07 16
...
//        float scale = Math.max(maxScaleX, maxScaleY);
        //       Log.d("Launcher", "LauncherAppTransition  playIconAnimators------ ");
...
//        appOpenAnimator.play(scaleAnim);
        ...
        // if (useUpwardAnimation) {
        // alpha.setStartDelay(APP_LAUNCH_ALPHA_START_DELAY);//屏蔽透明渐变动画 2021 07 16
...
//        appOpenAnimator.play(alpha);
        ...
        appOpenAnimator.addListener(new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator animation) {
              ...
              //  Log.d(TAG, "onAnimationEnd 显示图标 ");
                v.setVisibility(View.VISIBLE);//by xiaoyu   2021 07 16
    ...
    private ValueAnimator getOpeningWindowAnimators(View v, RemoteAnimationTargetCompat[] targets,
        ...
        // Log.d(TAG, "getOpeningWindowAnimators>>>");//与最近任务栏消失动画无关
        ...
        appAnimator.addUpdateListener(new MultiValueUpdateListener() {
            ...
            public void onUpdate(float percent) {
               ...
               // Log.d(TAG, "onUpdate: getOpeningWindowAnimators");
    ...
    private void registerRemoteAnimations() {
        Log.d(TAG, "registerRemoteAnimations");
        // Unregister this
        if (hasControlRemoteAppTransitionPermission()) {
    ...
    private RemoteAnimationRunnerCompat getWallpaperOpenRunner() {
        Log.d(TAG, "getWallpaperOpenRunner");
        return new LauncherAnimationRunner(mHandler, false /* startAtFrontOfQueue */) {
            ...
            public void onCreateAnimation(RemoteAnimationTargetCompat[] targetCompats,
                ...
                if (anim == null) {
                    ...
                    // anim.play(getClosingWindowAnimators(targetCompats));//屏蔽返回桌面动画 2021 07 17
    ...
    private Animator getClosingWindowAnimators(RemoteAnimationTargetCompat[] targets) {
        Log.d(TAG, "getClosingWindowAnimators");
        ...
        closingAnimator.addUpdateListener(new MultiValueUpdateListener() {
            ...
            FloatProp mAlpha = new FloatProp(1f, 0f, 25, 25, LINEAR);//125

            @Override
            public void onUpdate(float percent) {
                Log.d(TAG, "onUpdate: getClosingWindowAnimators");
                SurfaceParams[] params = new SurfaceParams[targets.length];
                for (int i = targets.length - 1; i >= 0; i--) {
                    RemoteAnimationTargetCompat target = targets[i];
                    float alpha;
                    if (target.mode == MODE_CLOSING) {
                        ...
                        //  matrix.postTranslate(0, mDy.value);//尝试去掉Y轴向下的动画
    ...
    private void createLauncherResumeAnimation(AnimatorSet anim) {
        Log.d(TAG, "createLauncherResumeAnimation  -------");
        if (mLauncher.isInState(LauncherState.ALL_APPS)) {
            ...
            workspaceAnimator.setDuration(10);//333
            workspaceAnimator.setInterpolator(Interpolators.DEACCEL_1_7);

            mDragLayer.getScrim().hideSysUiScrim(true);

            // Pause page indicator animations as they lead to layer trashing.
            // mLauncher.getWorkspace().getPageIndicator().pauseAnimations();//不要这个 2021 06 16
            mDragLayer.setLayerType(View.LAYER_TYPE_HARDWARE, null);

            workspaceAnimator.addListener(new AnimatorListenerAdapter() {
                @Override
                public void onAnimationEnd(Animator animation) {
                    Log.d(TAG, "onAnimationEnd resetContentView>>>>>>>");
                    resetContentView();
                }
            });
    ...
    private void resetContentView() {
        //mLauncher.getWorkspace().getPageIndicator().skipAnimationsToEnd();//不要这个 2021 06 16
