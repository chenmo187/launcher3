...
public class PageIndicatorDots extends View implements PageIndicator, Insettable {
    ...
    private Launcher mLauncher;//add by xiaoyu 2021 06 15
    ...
    public PageIndicatorDots(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mActiveColor = Color.GREEN;//Themes.getColorAccent(context);
        // mInActiveColor = Themes.getAttrColor(context, android.R.attr.colorControlHighlight);
        mInActiveColor = Color.WHITE;//换种颜色
        mIsRtl = Utilities.isRtl(getResources());
    }

    //----------设置跟随屏幕滚动小圆点-------2021 06 15--xiaoyu---
    @Override
    public void setInsets(Rect insets) {
        ...
        if (grid.isVerticalBarLayout()) {
            ...
            lp.gravity = Gravity.CENTER_HORIZONTAL | Gravity.BOTTOM | Gravity.CENTER;//居中2021 06 18  xiaoyu
