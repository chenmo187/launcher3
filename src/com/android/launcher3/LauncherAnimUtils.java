...
public class LauncherAnimUtils {
    ...
    private static String TAG = "LauncherAnimUtils";
    ...
    public static void cancelOnDestroyActivity(Animator a) {
        Log.d(TAG, "cancelOnDestroyActivity");
         a.addListener(sEndAnimListener);// 崩溃了 xiaoyu 注释掉这里 2021 06 16
    }
    ...
    public static int blockedFlingDurationFactor(float velocity) {
        Log.d(TAG, "blockedFlingDurationFactor");
