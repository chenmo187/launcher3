...
public abstract class PagedView<T extends View & PageIndicator> extends ViewGroup {
    ...
    public boolean requestChildRectangleOnScreen(View child, Rect rectangle, boolean immediate) {
        ...
        Log.d(TAG, "requestChildRectangleOnScreen: 下一页");
    ...
    public boolean dispatchUnhandledMove(View focused, int direction) {
        // Log.d(TAG, "dispatchUnhandledMove: direction:" + direction);
    ...
    private void setEnableFreeScroll(boolean freeScroll) {
        Log.d(TAG, "setEnableFreeScroll  freeScroll: " + freeScroll);
    ...
    public void requestChildFocus(View child, View focused) {
        Log.d(TAG, "requestChildFocus  focused: " + focused);
    ...
    public boolean snapToPage(int whichPage) {
        Log.d(TAG, "snapToPage: snapToPage index:" + whichPage);
        return snapToPage(whichPage, PAGE_SNAP_ANIMATION_DURATION);
    }
    ...
    public boolean performAccessibilityAction(int action, Bundle arguments) {
        ...
        switch (action) {
            case AccessibilityNodeInfo.ACTION_SCROLL_FORWARD: {
                Log.d(TAG, "performAccessibilityAction: ACTION_SCROLL_FORWARD");
            ...
            case AccessibilityNodeInfo.ACTION_SCROLL_BACKWARD: {
                Log.d(TAG, "performAccessibilityAction: ACTION_SCROLL_BACKWARD");
