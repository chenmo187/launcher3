...
public class FolderAnimationManager {
    ...
    public AnimatorSet getAnimator() {
        ...
        play(a, getAnimator(mFolder, View.TRANSLATION_Y, yDistance, 0f));
         play(a, getAnimator(mFolder, SCALE_PROPERTY, initialScale, finalScale));//无效果 2021 07 16
    ...
    private void addPreviewItemAnimators(AnimatorSet animatorSet, final float folderScale,
        ...
        for (int i = 0; i < numItemsInPreview; ++i) {
            ...
            Log.d("LauncherANM", "FolderAnimation addPreviewItemAnimators ");
            Animator scaleAnimator = getAnimator(btv, SCALE_PROPERTY, initialScale, finalScale);//无效果2021 07 16
            ...
            if (mFolder.getItemCount() > MAX_NUM_ITEMS_IN_PREVIEW) {
                ...
                if (mIsOpening) {
                    ...
                    //  scaleAnimator.setStartDelay(delay);//2021 07 16
                }
                translationX.setDuration(translationX.getDuration() - delay);
                translationY.setDuration(translationY.getDuration() - delay);
                // scaleAnimator.setDuration(scaleAnimator.getDuration() - delay);//2021 07 16
            }
