...
//        outRect.left += (1 - v.getScaleX()) * v.getWidth() / 5;//验证焦点背景色区域宽高 修改这里仅仅只是改变焦点背景色面积，改变不了触摸区域 2021 06 24
//        outRect.top += (1 - v.getScaleY()) * v.getHeight() / 5;
//
//        outRect.right = outRect.left + (int) (v.getScaleX() * v.getWidth() / 5);
//        outRect.bottom = outRect.top + (int) (v.getScaleY() * v.getHeight() / 5);
    }
