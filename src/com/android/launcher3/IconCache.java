...
public class IconCache {
    ...
    public Drawable getFullResIcon(String packageName, int iconId) {
        // Log.d(TAG, "getFullResIcon for widget: pkg " + packageName);
        Resources resources;
        try {
    ...
    public Drawable getFullResIcon(LauncherActivityInfo info, boolean flattenDrawable) {
       // Log.d(TAG, "getFullResIcon: 获取图标的app:" + info.getApplicationInfo().packageName);
        ...
        switch (pkgName) {
            case PKG_SETTINGS:
                return ContextCompat.getDrawable(mContext, R.mipmap.ic_launcher_settings);

            case PKG_SPEEDPLAY:
                return ContextCompat.getDrawable(mContext, R.mipmap.ic_launcher_speedplay);

            case PKG_BTPHONE:
                return ContextCompat.getDrawable(mContext, R.mipmap.ic_launcher_bt_phone);

            case PKG_BTMUSIC:
                return ContextCompat.getDrawable(mContext, R.mipmap.ic_launcher_bt_music);

            case PKG_APKINSTALLER:
                return ContextCompat.getDrawable(mContext, R.mipmap.ic_launcher_apk);
            case PKG_SPOTIFY:
                return ContextCompat.getDrawable(mContext, R.mipmap.ic_launcher_spotify);
            case PKG_GALLERY:
                return ContextCompat.getDrawable(mContext, R.mipmap.ic_launcher_gallery);
            case PKG_FILEMANAGER:
                return ContextCompat.getDrawable(mContext, R.mipmap.ic_launcher_filemanager);
            case PKG_NETFLIX:
                return ContextCompat.getDrawable(mContext, R.mipmap.ic_launcher_netflix);
            case PKG_WAZE:
                return ContextCompat.getDrawable(mContext, R.mipmap.ic_launcher_waze);
            case PKG_GBOARD:
                return ContextCompat.getDrawable(mContext, R.mipmap.ic_launcher_gboard);
            case PKG_GOOGLE_MAPS:
                return ContextCompat.getDrawable(mContext, R.mipmap.ic_launcher_googlemaps);
            case PKG_YOUTUBE_MUSIC:
                return ContextCompat.getDrawable(mContext, R.mipmap.ic_launcher_youtube_music);
        }
    ...
    protected CacheEntry cacheLocked(
        ...
        ComponentKey cacheKey = new ComponentKey(componentName, user);//UserHandle.SYSTEM
                ...
                if (info != null) {
                    ...
                    if (usePackageIcon) {
                        ...
                        CacheEntry packageEntry = getEntryForPackageLocked(
                                componentName.getPackageName(), user, false);//user
