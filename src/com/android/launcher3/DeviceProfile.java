...
public class DeviceProfile {
    ...
    public DeviceProfile(Context context, InvariantDeviceProfile inv,
        ...
        transposeLayoutWithOrientation =
                res.getBoolean(R.bool.hotseat_transpose_layout_with_orientation);//改为fasle不适应
        ...
        //设置桌面图标左右padding值   数字越大边距越小20dp 2021 07 20
        cellLayoutPaddingLeftRightPx = cellLayoutPaddingLeftRightMultiplier *
                res.getDimensionPixelSize(R.dimen.dynamic_grid_cell_layout_padding);

        //设置桌面图标底部padding值
        cellLayoutBottomPaddingPx = res.getDimensionPixelSize(R.dimen.dynamic_grid_cell_layout_bottom_padding);
        ...
        //设置桌面图标顶部padding值
        topWorkspacePadding =
                res.getDimensionPixelSize(R.dimen.dynamic_grid_workspace_top_padding);//原100dp
        ...
        workspaceCellPaddingXPx = res.getDimensionPixelSize(R.dimen.dynamic_grid_cell_padding_x);//修改这里可以调整名称边距 2021 06 26
        ...
        hotseatBarSidePaddingStartPx = isMultiWindowMode && isVerticalBarLayout()
                ? edgeMarginPx : 0;
        hotseatBarSizePx = 8;//8  2021 07 23 屏蔽    res.getDimensionPixelSize(R.dimen.dynamic_grid_hotseat_size);
//        hotseatBarSizePx = isVerticalBarLayout()
//                ? Utilities.pxFromDp(inv.iconSize, dm) + hotseatBarSidePaddingStartPx
//                + hotseatBarSidePaddingEndPx
//                : res.getDimensionPixelSize(R.dimen.dynamic_grid_hotseat_size)
//                + hotseatBarTopPaddingPx + hotseatBarBottomPaddingPx;
        Log.d("ATlog", "DeviceProfile11111 hotseatBarSizePx = " + hotseatBarSizePx);
        ...
        if (!isVerticalBarLayout() && isPhone && isTallDevice) {
            ...
            Log.d("ATlog", "DeviceProfile 22222 hotseatBarSizePx = " + hotseatBarSizePx);
    ...
    private void updateAvailableDimensions(DisplayMetrics dm, Resources res) {
        ...
        if (usedHeight > maxHeight) {
            ...
            Log.d("ATlog", "updateAvailableDimensions scale:" + scale);
            updateIconSize(scale, res, dm);//试验修改白色背景框边距  无效
        }
    ...
    private void updateIconSize(float scale, Resources res, DisplayMetrics dm) {
        ...
        Log.d("ATlog", "updateIconSize    iconSizePx: " +
                iconSizePx + "   iconTextSizePx:" + iconTextSizePx +
                "  iconDrawablePaddingPx:" + iconDrawablePaddingPx + "  cellHeightPx:" +
                cellHeightPx + "  cellWidthPx:" + cellWidthPx + "  isVerticalLayout:" + isVerticalLayout);
        ...
        if (isVerticalLayout) {
            ...
            // adjustToHideWorkspaceLabels(); 去掉屏蔽名称，显示出来  2021 06 17 xiaoyu
        }
    ...
    public Point getCellSize() {
        ...
        Log.d("ATlog", "getCellSize: availableWidthPx:" + availableWidthPx + "    paddingX:" + padding.x +
                "  availableHeightPx:" + availableHeightPx + "  paddingY:" + padding.y);
        return result;
    }
    ...
    private void updateWorkspacePadding() {
        ...
        if (isVerticalBarLayout()) {
            ...
            padding.top = 80;//原生默认设置0    设置到顶部边距，白色背景框缩小  2021 07 23
            padding.bottom = 1;//edgeMarginPx;
            if (isSeascape()) {
                padding.left = 3;//hotseatBarSizePx; 3
                padding.right = 3; //hotseatBarSizePx;//verticalDragHandleSizePx;  3
                Log.d("ATlog", "updateWorkspacePadding   hotseatBarSizePx:" + hotseatBarSizePx + "  edgeMarginPx:" + edgeMarginPx);
            } else {
                padding.left = 3;//hotseatBarSizePx;//verticalDragHandleSizePx; 12
                padding.right = 3; //hotseatBarSizePx;  12
                Log.d("ATlog", "updateWorkspacePadding 111   hotseatBarSizePx:" + hotseatBarSizePx + "  edgeMarginPx:" + edgeMarginPx);
            }
        } else {
            ...
            if (isTablet) {
                ...
                Log.d("ATlog", "updateWorkspacePadding  set padding finish >>>>>>> availablePaddingX: "
                        + availablePaddingX + "  availablePaddingY:" + availablePaddingY);
            } else {
                ...
                padding.set(desiredWorkspaceLeftRightMarginPx,
                        ...
                        paddingBottom);
//                Log.d("ATlog", "DeviceProfile updateWorkspacePadding workspace set padding " +
//                        " left-right:" + desiredWorkspaceLeftRightMarginPx +
//                        "  top: " + topWorkspacePadding + "  bottom:" + paddingBottom);
            }
