...
public class InvariantDeviceProfile {
    ...
    private static final float ICON_SIZE_DEFINED_IN_APP_DP = 88;//88;
    ...
    public InvariantDeviceProfile(Context context) {
        ...
        //----------根据屏幕的实际宽度来确定一排放几个---2021 06 17----
        int widthPixels = dm.widthPixels;//屏幕实际像素值
        //--------------------end-----------------------
...
//        minHeightDps = Utilities.dpiFromPx(Math.min(largestSize.x, largestSize.y), dm);
        minWidthDps = Utilities.dpiFromPx(145, dm);//145
        minHeightDps = Utilities.dpiFromPx(145, dm);
        ...
        iconSize = 150.0f;//130.0f
        iconBitmapSize = Utilities.pxFromDp(iconSize, dm);
        numRows = 2;//closestProfile.numRows;固定2行

        numColumns = (int) ((widthPixels * 0.885F) / iconBitmapSize) ;//根据宽度每排放几个  numColumns = closestProfile.numColumns;
        ...
        landscapeIconSize = 120;//150  interpolatedDeviceProfileOut.landscapeIconSize;

        iconTextSize = 17;//interpolatedDeviceProfileOut.iconTextSize;
        fillResIconDpi = getLauncherIconDensity(iconBitmapSize);
        Log.d("ATlog", "InvariantDeviceProfile: 当前name:" + closestProfile.name +
                " 当前显示行数:" + numRows + "   列数：" + numColumns
                + " iconBitmapSize:" + iconBitmapSize + "  屏幕宽度:" + widthPixels +
                "   landscapeIconSize:" + landscapeIconSize + " fillResIconDpi:" + fillResIconDpi);
