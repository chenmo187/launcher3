...
public class LauncherIcons implements AutoCloseable {
    private static String TAG = "LauncherIcons";
    private static final int DEFAULT_WRAPPER_BACKGROUND = Color.WHITE;//Color.WHITE;
    ...
    private LauncherIcons(Context context) {
        ...
        idp = LauncherAppState.getIDP(mContext);
    ...
    public BitmapInfo createIconBitmap(ShortcutIconResource iconRes) {
        try {
            ...
            if (resources != null) {
                Log.d(TAG, "createIconBitmap: " + iconRes.packageName);
    ...
    public BitmapInfo createIconBitmap(Bitmap icon) {
        ...
        Log.d(TAG, "createIconBitmap: 0000");
    ...
    public BitmapInfo createBadgedIconBitmap(Drawable icon, UserHandle user, int iconAppTargetSdk,
        ...
        Log.d(TAG, "createBadgedIconBitmap 11111");
    ...
    public Bitmap createScaledBitmapWithoutShadow(Drawable icon, int iconAppTargetSdk) {
        ...
        Log.d(TAG, "createScaledBitmapWithoutShadow: 222222");
    ...
    private Drawable normalizeAndWrapToAdaptiveIcon(Drawable icon, int iconAppTargetSdk,
        ...
        float scale = 1f;
        //注释掉这一部分可以去掉桌面图标背景色得白边 2021 06 25 xiaoyu
    ...
    private Bitmap createIconBitmap(Drawable icon, float scale) {
        ...
        return bitmap;
       // return addBorderToImage(bitmap, bitmap.getWidth());

    }

    /*
     * ---------------------------给图标添加边框处理 2021 07 29 可用系统自带圆角-----------------------------------------------------------
     *将createIconBitmap(Drawable icon, float scale)   return addBorderToImage(bitmap, sIconTextureWidth);
     *
     * */
    private static Bitmap addBorderToImage(Bitmap src, int iconSize) {
        Log.d(TAG, "addBorderToImage: size " + src.getWidth());
        int mRoundedRate = 15;//待验证参数值
        int sw = src.getWidth();
        int sh = src.getHeight();

//        Bitmap output = Bitmap.createBitmap(sw, sh,
//                Bitmap.Config.ARGB_8888);
//        Canvas canvas = new Canvas(output);
//        RectF outerRect = new RectF(0, 0, sw, sh);
//
//        Paint paint = new Paint(Paint.ANTI_ALIAS_FLAG | Paint.FILTER_BITMAP_FLAG);
//        LinearGradient mLinearGradientClamp = new LinearGradient(0, 0, 0, sh, new int[]{getCenterTopColor(src), getCenterBottomColor(src)}, null, Shader.TileMode.CLAMP);
//        paint.setShader(mLinearGradientClamp);
//        canvas.drawRoundRect(outerRect, sw / mRoundedRate, sh / mRoundedRate, paint);
//
//        paint.setXfermode(new PorterDuffXfermode(PorterDuff.Mode.SRC_ATOP));
//
//
//        Rect srcRect = new Rect(0, 0, sw, sh);
//        Rect dstRect = getDstRect(sw, sh, sw, sh);
//
