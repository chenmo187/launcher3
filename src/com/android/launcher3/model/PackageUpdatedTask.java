...
public class PackageUpdatedTask extends BaseModelUpdateTask {
    ...
    public void execute(LauncherAppState app, BgDataModel dataModel, AllAppsList appsList) {
        ...
        //-------add for load new install app on workspace  2021 06 15---xiaoyu-------
        if (LauncherAppState.isDisableAllApps()) {
            Log.d("ATlog", "PackageUpdatedTask updateToWorkSpace()");
    ...
    //add for load new install app on workspace   2021 06 15 add
    public void updateToWorkSpace(Context context, LauncherAppState app, AllAppsList appsList) {
        ...
        if (!added.isEmpty()) {
            Log.d("ATlog", "PackageUpdatedTask added success");
